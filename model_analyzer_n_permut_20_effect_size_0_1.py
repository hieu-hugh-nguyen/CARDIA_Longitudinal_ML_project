# force to use quadratic loss (similar to Brier's Score)
...
#        self.num_permutations = self.process_keyword_arg("num_permutations", constants.DEFAULT_NUM_PERMUTATIONS)
        self.num_permutations = 20 #100 #20 #200
...
#        self.importance_significance_level = self.process_keyword_arg("importance_significance_level", 0.1)
        self.importance_significance_level = self.process_keyword_arg("importance_significance_level", 1.1) #1
...
class TemporalModelAnalyzer_1(ModelAnalyzer_1):
...
#        self.window_effect_size_threshold = self.process_keyword_arg("window_effect_size_threshold", 0.01)
        self.window_effect_size_threshold = self.process_keyword_arg("window_effect_size_threshold", 0.1)
