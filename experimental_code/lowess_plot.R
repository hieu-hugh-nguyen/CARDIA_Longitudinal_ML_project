...
loading.dir = paste0(work_dir,'/rdata_files/rsf_ascvd_var_tsfeatures_fold_',fold)
trained.model = get(load(paste0(loading.dir, '/rsf_ascvd_var_tsfeatures.RData')))
...
# get the top var:
loading_dir = loading.dir

var_order = read.csv(file = paste0(loading_dir,
                                   '/depth_rank.csv'))

# var_order = apply(var_order, 2, as.character)
var_order_variable = var_order$Variable

n_top = 20
var_top_n = var_order_variable[1:n_top]
