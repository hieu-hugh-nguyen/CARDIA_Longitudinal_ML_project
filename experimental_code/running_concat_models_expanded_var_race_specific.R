...
running_concat_models <- function(data_, data_name){
  ...
  #   
  #   
  #   model_name <- paste0('cox_expanded_var_concat_', data_name)
  #   gc()
  ...
  #   
  #   
  #   model_name <- paste0('lasso_expanded_var_concat_', data_name)
  #   gc()
  #   main_dir <- paste0(work_dir, '/rdata_files')
  #   sub_dir <- paste0(model_name, '_fold_',fold)
  #   
  ...
  for (fold in 1:nfolds){
    ...
    model_name <- paste0('rsf_expanded_var_concat_', data_name)
    gc()
    main_dir <- paste0(work_dir, '/rdata_files')
    sub_dir <- paste0(model_name, '_fold_',fold)
...
running_concat_models(data_white, 'white_only')
running_concat_models(data_black, 'black_only')