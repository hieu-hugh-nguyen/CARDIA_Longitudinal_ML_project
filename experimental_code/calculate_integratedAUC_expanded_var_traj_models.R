...
model_list = c(
  ## model_name = 
  'rsf_expanded_var_traj_only_ch_4'
  ,'rsf_expanded_var_traj_only_kl_4'
  ,'rsf_expanded_var_traj_only_ccc_4'
  ,'rsf_expanded_var_traj_only_hartigan_4'
  ,'rsf_expanded_var_traj_only_scott_4'
  ,'rsf_expanded_var_traj_only_trcovw_4'
  ,'rsf_expanded_var_traj_only_tracew_4'
  ,'rsf_expanded_var_traj_only_friedman_4'
  ,'rsf_expanded_var_traj_only_gap_4'
  ,'rsf_expanded_var_traj_only_marriot_4'
  ,'rsf_expanded_var_traj_only_rubin_4'
  ,'rsf_expanded_var_traj_only_cindex_4'
  ,'rsf_expanded_var_traj_only_db_4'
  ,'rsf_expanded_var_traj_only_silhouette_4'
  ,'rsf_expanded_var_traj_only_duda_4'
  
  ,'rsf_expanded_var_traj_only_ball_4'
  ,'rsf_expanded_var_traj_only_pseudot2_4'
  ,'rsf_expanded_var_traj_only_beale_4'
  ,'rsf_expanded_var_traj_only_ptbiserial_4'
  ,'rsf_expanded_var_traj_only_sdindex_4'
  ,'rsf_expanded_var_traj_only_sdbw_4'
  ,'rsf_expanded_var_traj_only_aic_bic'
