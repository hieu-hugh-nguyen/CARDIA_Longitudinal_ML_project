...
# #    df_                = pd.read_csv('./data/data_longi_long_format_ascvd_risk_factors.csv')
#     df_                = pd.read_csv('./data/data_longi_ascvd_for_dynamic_deephit.csv')
    

#     bin_list           = ['MALE', 'RACEBLACK', 'DIAB', 'HBM', 'SMKNW']
#     cont_list          = ['AGE_Y0', 'CHOL', 'SBP', 'HDL']
#     feat_list          = cont_list + bin_list
    

# #    df_                = df_.rename(columns={"ID": "id", "time_te_in_yrs": "tte", "exam_year":"times", "status": "label" })
#     df_                = df_.rename(columns={"ID": "id", "time": "tte", "exam_year": "times", "event": "label" })
