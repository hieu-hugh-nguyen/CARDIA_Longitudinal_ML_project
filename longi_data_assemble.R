...
# landmark: focusing on indivisuals still at risk at the landmark time and consider their history up to the landmark time 

# how to compare DL SA and joint model with methods using cross-sectional data only? See code for JM
