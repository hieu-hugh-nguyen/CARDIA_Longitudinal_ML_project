...
running_y15_models <- function(data_, data_name){
  ...
  for (fold in 1:nfolds){
    ...
    model_name <- paste0('cox_expanded_var_y15_', data_name)
    gc()
  ...
  model_name <- paste0('lasso_expanded_var_y15_', data_name)
  gc()
  main_dir <- paste0(work_dir, '/rdata_files')
  sub_dir <- paste0(model_name, '_fold_',fold)
 ...
 # loading.dir <- paste0(work_dir, '/rdata_files/', model_name, '_fold_', fold)
  ...
  for (fold in 1:nfolds){
    ...
    model_name <- paste0('rsf_expanded_var_', data_name) 
    gc()
    main_dir <- paste0(work_dir, '/rdata_files')
    sub_dir <- paste0(model_name, '_fold_',fold)
...
running_y15_models(data_white, 'white_only')
running_y15_models(data_black, 'black_only')
