...
write.csv(train.ID, paste0(work_dir, '/csv_files','/all_training_set_ID_2.csv')
          ,row.names = F)
write.csv(valid.ID, paste0(work_dir, '/csv_files','/all_validation_set_ID_2.csv')
          ,row.names = F)
write.csv(test.ID, paste0(work_dir, '/csv_files','/all_testing_set_ID_2.csv')
          ,row.names = F)
